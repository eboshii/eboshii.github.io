...
f(x_0,y_0,x_1,y_1) = w
 ...
 The $(0,-1,x,y)$ space is considered a node centric *substrate* in ES-HyperNEAT, in this case centered arbitrarily on $(0,-1)$ in order to construct the 2-D substrate. The 2-dimensional substrate is searched, using Quadtree, to identify areas of high complexity (which corresponds to areas of high variance in $w$). 
